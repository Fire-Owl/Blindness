...
<body>
    ...
    <div class="main">
        ...
        <div class="main__article--top-left">
            <p>Le handicap est une notion complexe et évolutive. Il désigne l'incapacité d'un individu à vivre et agir pleinement dans son environnement, en raison de déficiences physiques, mentales ou sensorielles.</p>
        </div>
