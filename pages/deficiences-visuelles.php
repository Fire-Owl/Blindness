...
<div class="main">
        ...
        <div class="main__article--top">
            <div class="main__article--title"><h2>Définition</h2></div>
            <div class="main__article--top-left"><p>La déficience visuelle désigne les troubles liés à la fonction visuelle. Elle repose sur deux critères : l'état du champ visuel et l’acuité visuelle. À partir de là, on distingue deux catégories de personnes atteintes de déficience. Les aveugles dont l’acuité est égale ou inférieur à 1/10 et les malvoyants dont l’acuité est au-dessus.</p>
            <div class="main__article--top-left--partie-2">Elle se manifeste sous de nombreuses formes ; une vision floue, réduite en forte luminosité ou pénombre, un champ rétréci ou entrecoupé, une absence de relief, de couleur.
            </div>  
           </div>
        ...
        <div class="main__article--center">
            <div class="main__article--center-right"><p>En France, on recense 1 500 000 personnes malvoyantes et <br>70 000 aveugles. Les aveugles représentent seulement 14 % des déficients visuels.
            </p></div>
        </div>
