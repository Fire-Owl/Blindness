<?php include "../includes/header.php";?>
    ...
    <div class="main">
        <div class="main__title">
            <h1 tabindex="0">IV. Statistiques</h1>
        </div>
        ...
        <div id="charts">
            ...
            <div class="charts__container">
                ...
                <p class="charts__item charts__item--paragraph" tabindex="0">Sur leur lieu de travail et à leur domicile, les personnes aveugles peuvent disposer de lecteurs d'écrans différents. Les statistiques montrent que les personnes aveugles utilisent plutôt majoirtairement le même lecteur d'écrans pour naviguer sur internet.
                </p>
            </div>

            <h2 class="charts__title" tabindex="0">Types d'écrans</h2>
            <div class="charts__container">
            ...
            <h2 class="charts__title" tabindex="0">Smartphones</h2>
            <div class="charts__container">
                <div class="charts__item">
